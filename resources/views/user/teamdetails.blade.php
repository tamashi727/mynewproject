...
<body>
   <!--[if lt IE 8]>
    ...
    <div class="team-details pt-100 pb-55">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div class="team-details-wrap">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="thumb">
                                    <img src="{{asset('assets/images/bg/team-big-1.jpeg')}}" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6 my-auto">
                                <div class="content">
                                    <h2 class="title">Chris B. Brown</h2>
                                    <div class="details__lists">
                                        <ul>
                                            <li><span>Position:</span> Chief Executive Officer</li>
                                            <li><span>Responsibility:</span> Brand Development, Brand Integration</li>
                                            <li><span>Experience:</span> 10 Years</li>
                                            <li><span>Email:</span> chriss.moore@mail.com</li>
                                            <li><span>Phone:</span> 507 - 541 - 4567</li>
                                            <li><span>Fax:</span> 507 - 541 - 4568</li>
                                        </ul>
                                    </div>
                                    <div class="social__links mt-45">
                                        <a href="#0" class="fb"><i class="fab fa-facebook-f"></i></a>
                                        <a href="#0" class="tw"><i class="fab fa-twitter"></i></a>
                                        <a href="#0" class="db"><i class="fab fa-dribbble"></i></a>
                                        <a href="#0" class="bh"><i class="fab fa-behance"></i></a>
                                        <a href="#0" class="yt"><i class="fab fa-youtube"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <!-- about area start -->
    <section class="about__area about__area--5 about__area--6">
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-12">
                    <div class="about__wrap about__wrap--2 about__wrap--3">
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="about__bg about__bg--6 bg_img" data-background="assets/images/bg/about-bg-7.jpeg">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="skill-wrap skill-wrap--2">
                                    ...
                                    <div class="skill">
                                        <div class="skill__box mb-30">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar wow slideInLeft" role="progressbar"
                                                    style="width: 92%; visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: slideInLeft;"
                                        ...
                                        <div class="skill__box mb-30">
                                            <h4 class="title">Architecture Develop</h4>
                                            <div class="progress">
                                                <div class="progress-bar wow slideInLeft" role="progressbar"
                                                    style="width: 67%; visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: slideInLeft;"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" data-wow-duration="1s" data-wow-delay=".5s">
                                                    <span>67%</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="skill__box mb-30">
                                            <h4 class="title">Best UIX Design</h4>
                                            <div class="progress">
                                                <div class="progress-bar wow slideInLeft" role="progressbar"
                                                    style="width: 81%; visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: slideInLeft;"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" data-wow-duration="1s" data-wow-delay=".5s">
                                                    <span>81%</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="skill__box">
                                            ...
                                            <div class="progress">
                                                <div class="progress-bar wow slideInLeft" role="progressbar"
                                                    style="width: 62%; visibility: visible; animation-duration: 1s; animation-delay: 0.5s; animation-name: slideInLeft;"
                                                    aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" data-wow-duration="1s" data-wow-delay=".5s">
                                                    <span>62%</span>
                                                </div>
                                            </div>
