     ...
     <div class="container">
         <div class="row mt-none-30">
             ...
             <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                 <div class="team__box">
                     <div class="thumb">
                         <img src="{{asset('assets/images/team/team-5.jpeg')}}" alt="">
                         <div class="social__icons">
                             <a href="#0"><i class="fab fa-facebook-f"></i></a>
                             <a href="#0"><i class="fab fa-twitter"></i></a>
                             <a href="#0"><i class="fab fa-behance"></i></a>
             ...
             <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                 <div class="team__box">
                     <div class="thumb">
                         <img src="{{asset('assets/images/team/team-6.jpeg')}}" alt="">
                         <div class="social__icons">
                             <a href="#0"><i class="fab fa-facebook-f"></i></a>
                             <a href="#0"><i class="fab fa-twitter"></i></a>
                             <a href="#0"><i class="fab fa-behance"></i></a>
             ...
             <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                 <div class="team__box">
                     <div class="thumb">
                         <img src="{{asset('assets/images/team/team-7.jpeg')}}" alt="">
                         <div class="social__icons">
                             <a href="#0"><i class="fab fa-facebook-f"></i></a>
                             <a href="#0"><i class="fab fa-twitter"></i></a>
                             <a href="#0"><i class="fab fa-behance"></i></a>
             ...
             <div class="col-xl-3 col-lg-4 col-md-6 mt-30">
                 <div class="team__box">
                     <div class="thumb">
                         <img src="{{asset('assets/images/team/team-8.jpeg')}}" alt="">
                         <div class="social__icons">
                             <a href="#0"><i class="fab fa-facebook-f"></i></a>
                             <a href="#0"><i class="fab fa-twitter"></i></a>
                             <a href="#0"><i class="fab fa-behance"></i></a>
         ...
         <div class="row">
             <div class="col-xl-6">
                 <div class="video__bg pr-50">
                     <img src="{{ asset('assets/images/bg/video-bg-2.jpeg')}}" alt="">
                 </div>
             </div>
             <div class="col-xl-6">
